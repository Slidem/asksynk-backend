...
import { AllExceptionsFilter } from "src/platform/errors/errors.filter";
...
import { TxModule } from "./platform/db/tx.module";
import { LoggerConfigModule } from "./platform/logger/logger.config";
